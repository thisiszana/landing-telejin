      ...
      <div className="grid grid-cols-12 gap-4 max-lg:mt-3">
        <Link href="/" className="inline-block col-span-7 lg:col-span-4 flex-1">
          <div className="h-full lg:h-28 bg-[#fbe8e4] flex max-lg:flex-col justify-evenly items-center relative rounded-[20px] shadow-headerShadow">
            <div className="relative w-[77px] h-[45px] lg:w-[74px] lg:h-[72px] overflow-hidden group">
              <Image
                src="/images/otherServices/ser2.png"
                width={120}
                height={120}
                alt="other services image"
                className="absolute inset-0 w-full h-full object-cover rounded-[2px] z-10"
              />
            ...
            <button className="rounded-[50px] flex justify-center items-center cursor-pointer bg-[#b000ff] text-white lg:hidden w-[86px] h-6  text-xs">
              مشاهده
            </button>
          </div>
        </Link>
        ...
        <div className="col-span-5 lg:col-span-8 flex flex-col gap-4 lg:flex-row">
          <Link href="/" className="inline-block flex-1">
            <div className="bg-white flex max-lg:flex-col justify-evenly items-center h-24 lg:h-28 relative rounded-[20px] shadow-headerShadow">
              <div className="relative">
                ...
                />
                <div className="absolute top-7 left-4 lg:top-7 lg:left-[45px] bg-cardColor1 rounded-full shadow-cardShadowSm1 lg:shadow-cardShadowMain1"></div>
              </div>
          ...
          <Link href="/" className="inline-block flex-1">
            <div className="bg-white flex max-lg:flex-col justify-evenly items-center h-24 lg:h-28 relative rounded-[20px] shadow-headerShadow">
              <div className="relative">
                ...
                />
                <div className="absolute top-7 left-4 lg:top-7 lg:left-5 bg-cardColor1 rounded-full shadow-cardShadowSm1 lg:shadow-cardShadowMain1"></div>
              </div>
              <h5 className="font-bold text-[#2c0767] text-[13px] lg:text-[20px] leading-[20.15px] lg:leading-[31px] text-center">
                آمبولانس
              </h5>
